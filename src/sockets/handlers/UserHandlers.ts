...
export class UserHandlers {
  ...
  public handleUserConnection = async (socket: SocketWithUser, connectedUsers: RoomManager) => {
  ...
  public handleUserDisconnection = (socket: SocketWithUser, connectedUsers: RoomManager) => {
